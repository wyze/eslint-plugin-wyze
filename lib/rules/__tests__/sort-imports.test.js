...
new RuleTester({ parserOptions }).run('sort-imports', rule, {
  ...
  invalid: [
    ...
    // prove sorting using wrong delim when import isn't on top line
    {
      code: `
      const someVar = '5'
    ...
    // typescript
    {
      code: `
      import {
        VersionCardSchemaFragmentFragment,
        VersionCardUsageStatsFragmentFragment,
        VersionCardServiceFragmentFragment,
      } from 'imports/shared/graphql/types';
      `,
      errors: [
        {
          message: "Member 'VersionCardServiceFragmentFragment' of the import declaration should be sorted" +
            ' alphabetically.',
          type: 'ImportSpecifier',
        },
      ],
